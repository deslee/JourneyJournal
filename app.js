	...
	render: function() {
		...
		return (
			React.createElement("div", {className: "journey_container"}, 
				...
				React.createElement("div", {className: "journey_toolbar entry_tags_input" + (this.state.focused ? ' hide':'')}, 
